...
struct ClaudePeakHoursTests {
    ...
    func `weekday morning before peak`() {
        ...
        #expect(status.label == "非高峰期 · 高峰期于 1h")
    }
    ...
    func `weekday just before peak`() {
        ...
        #expect(!status.isPeak)
        #expect(status.label == "非高峰期 · 高峰期于 15m")
    }
    ...
    func `weekday peak start`() {
        ...
        #expect(status.isPeak)
        #expect(status.label == "高峰期 · 结束于 6h")
    }
    ...
    func `weekday mid peak`() {
        ...
        #expect(status.isPeak)
        #expect(status.label == "高峰期 · 结束于 2h 30m")
    }
    ...
    func `weekday peak end boundary`() {
        ...
        #expect(status.isPeak)
        #expect(status.label == "高峰期 · 结束于 1m")
    }
    ...
    func `weekday after peak`() {
        ...
        #expect(!status.isPeak)
        #expect(status.label == "非高峰期 · 高峰期于 18h")
    }
    ...
    func `weekday late evening`() {
        ...
        #expect(!status.isPeak)
        #expect(status.label == "非高峰期 · 高峰期于 9h")
    }
    ...
    func `saturday morning`() {
        ...
        #expect(!status.isPeak)
        #expect(status.label == "非高峰期 · 高峰期于 46h")
    }
    ...
    func `sunday evening`() {
        ...
        #expect(!status.isPeak)
        #expect(status.label == "非高峰期 · 高峰期于 11h")
    }
    ...
    func `friday after peak`() {
        ...
        #expect(!status.isPeak)
        #expect(status.label == "非高峰期 · 高峰期于 65h")
    }
    ...
    func `friday peak`() {
        ...
        #expect(status.isPeak)
        #expect(status.label == "高峰期 · 结束于 2h")
    }
    ...
    func `spring forward weekend`() {
        ...
        #expect(!status.isPeak)
        #expect(status.label == "非高峰期 · 高峰期于 45h")
    }
    ...
    func `monday midnight`() {
        ...
        #expect(!status.isPeak)
        #expect(status.label == "非高峰期 · 高峰期于 8h")
    }
    ...
    func `peak with minute granularity`() {
        ...
        #expect(status.isPeak)
        #expect(status.label == "高峰期 · 结束于 1h 45m")
    }
    ...
    func `saturday midnight`() {
        ...
        #expect(!status.isPeak)
        #expect(status.label == "非高峰期 · 高峰期于 56h")
    }
    ...
    func `weekday one minute before peak with seconds`() {
        ...
        #expect(!status.isPeak)
        #expect(status.label == "非高峰期 · 高峰期于 1m")
    }
