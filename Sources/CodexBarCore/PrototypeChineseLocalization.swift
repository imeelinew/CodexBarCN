...
public enum PrototypeChineseLocalization {
    ...
    private static let directMap: [String: String] = [
        ...
        "Pace: ": "进度：",
        "Activity: ": "活动：",
        "Show provider storage usage": "显示提供方存储用量",
        "Show local disk usage in menus. Scans known provider-owned paths in the background.":
            "在菜单中显示本地磁盘用量。在后台扫描已知的提供方路径。",
        "No providers selected for Overview.": "未选择总览提供方。",
        "No overview data available.": "暂无总览数据。",
        "Buy Credits...": "购买积分...",
        "Credits history": "积分历史",
        "Usage breakdown": "用量分解",
        "Usage history (30 days)": "用量历史（30天）",
        "MCP details": "MCP 详情",
        "Operational": "正常",
        "Partial outage": "部分故障",
        "Major outage": "严重故障",
        ...
        "No limit set for the API key": "未为 API 密钥设置限额",
        "API key limit unavailable right now": "API 密钥限额当前不可用",
        "Off-peak": "非高峰期",
        "Peak": "高峰期",
        "Window: ": "窗口：",
        "Resets: ": "重置：",
        ...
        "remaining": "剩余",
        "tokens": "tokens",
        "API Key 限额": "API Key 限额",
        "Updates managed by Homebrew. Run: brew upgrade --cask steipete/tap/codexbar":
            "更新由 Homebrew 管理。请运行：brew upgrade --cask steipete/tap/codexbar",
        "ends in": "结束于",
        "peak in": "高峰期于",
        "Storage:": "存储：",
        "No data available": "暂无数据",
        "last fetch failed": "上次获取失败",
        "usage not fetched yet": "尚未获取用量",
        "Add Account": "添加账号",
        "Automatic": "自动",
        "Primary (API key limit)": "主要（API 密钥限额）",
        "Menu bar metric": "菜单栏指标",
        "Shows the DeepSeek balance in the menu bar.": "在菜单栏中显示 DeepSeek 余额。",
        "Choose which window drives the menu bar percent.": "选择驱动菜单栏百分比的窗口。",
        "Credits": "积分",
        "Balance": "余额",
        "State": "状态",
        "Source": "来源",
        ...
        "Hide details": "隐藏详情",
        "Show details": "显示详情",
        "Managed account storage unavailable": "托管账号存储不可用",
        "Managed Codex login in progress…": "Codex 托管登录进行中…",
        "Managed Codex accounts unavailable": "Codex 托管账号不可用",
        "CodexBar could not read managed account storage. Recover the store before adding another account.":
            "CodexBar 无法读取托管账号存储。添加其他账号前请先恢复存储。",
        "Codex account login already running": "Codex 账号登录已在进行中",
        "Wait for the current managed Codex login to finish before adding another account.":
            "请等待当前的托管 Codex 登录完成后，再添加其他账号。",
        ...
        "Codex login completed, but no account email was available. Try again after confirming the account is fully signed in.":
            "Codex 登录已完成，但未获取到账号邮箱。请确认账号已完全登录后重试。",
        "CodexBar found multiple workspaces, but no workspace was selected.":
            "CodexBar 发现多个工作区，但未选择任何工作区。",
        "CodexBar refused to modify an unexpected managed home path: %@":
            "CodexBar 拒绝修改意外的托管主目录路径：%@",
        "Could not add Codex account": "无法添加 Codex 账号",
        "Claude CLI not found": "未找到 Claude CLI",
        "Install the Claude CLI (npm i -g @anthropic-ai/claude-code) and try again.":
            "请安装 Claude CLI（npm i -g @anthropic-ai/claude-code）后重试。",
        ...
        "Install the Gemini CLI (npm i -g @google/gemini-cli) and try again.":
            "请安装 Gemini CLI（npm i -g @google/gemini-cli）后重试。",
        "Could not open Terminal for Gemini": "无法为 Gemini 打开终端",
        "No output captured.": "未捕获到输出。",
        "%@ login successful": "%@ 登录成功",
        "You can return to the app; authentication finished.": "您可以返回应用；认证已完成。",
        "Cursor login failed": "Cursor 登录失败",
        "No system account": "无系统账号",
        ...
        "A managed Codex login is already running. Wait for it to finish before adding or re-authenticating another account.":
            "托管 Codex 登录已在进行中。请等待其完成后再添加或重新认证其他账号。",
        "Managed account storage is unreadable. Live account access is still available, but managed add, re-auth, and remove actions are disabled until the store is recoverable.":
            "托管账号存储不可读。实时账号访问仍然可用，但在存储恢复之前，托管的添加、重新认证和移除操作将被禁用。",
        "Now": "现在",
        "days": "天",
        "hours": "小时",
        "minutes": "分钟",
        "Loading…": "加载中…",
        "No log yet. Fetch to load.": "暂无日志。请点击获取以加载。",
        "Not found": "未找到",
        "No fetch attempts yet.": "尚无获取尝试。",
        "No cached cookies found.": "未找到缓存的 Cookie。",
    ]
