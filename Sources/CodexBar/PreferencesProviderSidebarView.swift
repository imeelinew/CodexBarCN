...
private struct ProviderSidebarRowView: View {
    ...
    var body: some View {
        ...
        HStack(alignment: .center, spacing: 10) {
            ProviderSidebarReorderHandle()
                ...
                .help(PrototypeChineseLocalization.text("Drag to reorder"))
                .onDrag {
    ...
    private var statusText: String {
        ...
        if lines.count >= 2 {
            ...
            return "\(PrototypeChineseLocalization.text("Disabled")) — \(first)\n\(rest)"
        }
        return "\(PrototypeChineseLocalization.text("Disabled")) — \(self.subtitle)"
    }
}
...
private struct ProviderSidebarReorderHandle: View {
    var body: some View {
        ...
        .accessibilityLabel(PrototypeChineseLocalization.text("Reorder"))
    }
}
